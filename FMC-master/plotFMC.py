...
def baseplot(spacing, plotname):
    ...
    plt.text(-0.95, -0.6, 'N', horizontalalignment='right', fontsize=20)
    plt.text(0.95, -0.6, 'R', horizontalalignment='left', fontsize=20)
    plt.text(0, 1.1, 'SS', horizontalalignment='center', fontsize=20)
