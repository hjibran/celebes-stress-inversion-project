...
def shmax_plot(lon, lat, down, up, AR, clus):
    ...
    fig.plot(data=data, style="w1.25c", fill=fill, cmap=False, transparency=25, pen=pen)
...
fig.coast(region=[117.5, 126, -3.5, 3.5],
          #land='lightgray',
          resolution='f',
          water='white'
...
fig.basemap(rose="jBR+w1.2c+lW,E,S,N+o0.1c/0.1c+f2") 
