...
grid = pygmt.datasets.load_earth_relief(resolution="30s", # resolution of earth relief
                                        ...
                                        region=[120.12075806451612-1, 120.12075806451612+1, -1.1031451612903227-1, -1.1031451612903227+1],
                                        )
...
fig.coast(region=[120.12075806451612-1, 120.12075806451612+1, -1.1031451612903227-1, -1.1031451612903227+1],
          #land='lightgray',
          resolution='f',
          water='white'
