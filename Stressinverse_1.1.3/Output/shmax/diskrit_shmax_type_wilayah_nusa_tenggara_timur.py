...
table = pd.read_csv("/mnt/d/celebes-stress-inversion-project/Stressinverse_1.1.3/Output/shmax/shmax_wilayah_nusa_tenggara_timur.csv")
...
fig.coast(region=[124.2, 126.8, -9.2, -7.2],
          #land='lightgray',
          resolution='f',
          water='white'
...
for i in range(len(table1)):
    shmax_plot(table1['lon'][i], table1['lat'][i], table1['down'][i], table1['up'][i], table1['AR'][i], table1['name'][i])
