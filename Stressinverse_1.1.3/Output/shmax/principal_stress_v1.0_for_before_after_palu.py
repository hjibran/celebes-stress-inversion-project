...
cluster_folder=['/mnt/d/celebes-stress-inversion-project/Stressinverse_1.1.3/Output/eps0.40pts15/new_shmax/palu_before_2018', '/mnt/d/celebes-stress-inversion-project/Stressinverse_1.1.3/Output/eps0.40pts15/new_shmax/palu_after_2018']
lonlat_folder=['/mnt/d/celebes-stress-inversion-project/Result/eps0.40min15-final/clustered/palu0.4before.csv', '/mnt/d/celebes-stress-inversion-project/Result/eps0.40min15-final/clustered/palu0.4after.csv']
parameter = [0, 1]
...
for file in range(len(cluster_folder)):
    #for clus in range(10):
        data = pd.read_csv(cluster_folder[file]+"/output_origin.csv")
        data_bootstrap = pd.read_csv(cluster_folder[file]+"/output_bootstarap.csv")
        ...
        matrix[i][0] = parameter[file]; matrix[i][1] = float(0); matrix[i][2] = mean_longitude; matrix[i][3] = mean_latitude 
...
table.to_csv("/mnt/d/celebes-stress-inversion-project/Stressinverse_1.1.3/Output/shmax_before_after_palu.csv", index=False)