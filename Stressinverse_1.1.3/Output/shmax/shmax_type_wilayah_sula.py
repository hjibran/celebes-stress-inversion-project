...
def shmax_plot(lon, lat, down, up, fill):
    ...
    fig.plot(data=data, style="w3c", fill=fill, cmap=True, transparency=25, pen='black')

table = pd.read_csv("/mnt/d/celebes-stress-inversion-project/Stressinverse_1.1.3/Output/shmax/shmax_wilayah_sula.csv")
