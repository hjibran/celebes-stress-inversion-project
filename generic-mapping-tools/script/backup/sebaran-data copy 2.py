...
pygmt.makecpt(cmap="jet", reverse = False ,series=[FM.depth.min(),FM.depth.max()])
...
fig.colorbar(frame=["a10"], position="jBl+o1c/1.5c+w4.5c/0.15c+mc")
fig.text(x=118.15, y=-5.25, text="Depth (KM)", font="9p,Helvetica-Bold,black")
...
fig.savefig("/mnt/d/celebes-stress-inversion-project/generic-mapping-tools/maps/sebaran-data-b.png")
#fig.show()