...
buffer03515 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/eps0.35min15-final/eps0.35pts15-bagian-selatan.shp")
buffer04015 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/eps0.40min15-final/eps0.40pts15-bagian-selatan.shp")
buffer05015 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/eps0.50min15-final/eps0.50pts15-bagian-selatan.shp")

# download and store earth relief
grid = pygmt.datasets.load_earth_relief(resolution="30s", # resolution of earth relief
                                        region=[118.5, 123, -4.5, -1.5], # boarder of map: [minlon, maxlon, minlat, maxlat]
...
fig.plot(x=FM.longitude, y=FM.latitude, style="c0.15c", pen="1p,black", fill='gray', label="Episenter")
...
fig.text(x=118.85, y=-3.40, text="Mamuju", font=font)
fig.plot(x=[118.85, 118.9], y=[-3.30, -2.68], pen="1.5p,black")
...
"""
fig.basemap(
    rose="jTL+w1.2c+lW,E,S,N+o0.1c/0.1c+f2",
