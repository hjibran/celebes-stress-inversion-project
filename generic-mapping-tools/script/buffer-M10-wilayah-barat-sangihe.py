...
buffer03515 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/eps0.35min15-final/eps0.35pts15-wilayah-barat-sangihe.shp")
buffer04015 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/eps0.40min15-final/eps0.40pts15-wilayah-barat-sangihe.shp")
buffer05015 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/eps0.50min15-final/eps0.50pts15-wilayah-barat-sangihe.shp")

# download and store earth relief
grid = pygmt.datasets.load_earth_relief(resolution="30s", # resolution of earth relief
                                        region=[124.4, 126.9, 4, 6.6], # [124.35, 126, 4, 5.7], # boarder of map: [minlon, maxlon, minlat, maxlat]
                                        registration="gridline")
fig = pygmt.Figure()

# plot grid image
fig.grdimage(grid=grid, # call grid
             frame=["a1", "EWsN"],#, "+tPulau Sulawesi"],
             projection="M10c",
...
fig.plot(x=FM.longitude, y=FM.latitude, style="c0.2c", pen='1p,black', fill="gray", label="Episenter")
...
fig.basemap(
    rose="jTL+w1.3c+lW,E,S,N+o0.2c/0.2c+f2",
