...
buffer03515 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/eps0.35min15-final/eps0.35pts15-wilayah-nusa-tenggara-timur.shp")
buffer04015 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/eps0.40min15-final/eps0.40pts15-wilayah-nusa-tenggara-timur.shp")
buffer05015 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/eps0.50min15-final/eps0.50pts15-wilayah-nusa-tenggara-timur.shp")

# download and store earth relief
grid = pygmt.datasets.load_earth_relief(resolution="30s", # resolution of earth relief
                                        region=[124.2, 126.8, -9.4, -6.8],#[124.2, 126.8, -8.6, -6.8], # boarder of map: [minlon, maxlon, minlat, maxlat]
