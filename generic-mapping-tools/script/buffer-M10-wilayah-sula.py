...
buffer05015 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/eps0.50min15-final/eps0.50pts15-wilayah-sula.shp")

# download and store earth relief
grid = pygmt.datasets.load_earth_relief(resolution="30s", # resolution of earth relief
                                        region=[125.5, 128, -3.5, -2], # boarder of map: [minlon, maxlon, minlat, maxlat]
...
fig.basemap(
    rose="jTR+w1.3c+lW,E,S,N+o0.2c/0.2c+f2",
