...
fig.plot(x=FM.longitude, y=FM.latitude, style="c0.05c", fill='black', label="Episenter")

fig.plot(data=buffer03515, pen="1p,springgreen3", label="ε=0.35 MinPts=15")
fig.plot(data=buffer04015, pen="1p,gold2", label="ε=0.40 MinPts=15")
fig.plot(data=buffer05015, pen="1p,tomato", label="ε=0.50 MinPts=15")
...
fig.basemap(
    rose="jBL+w1.3c+lW,E,S,N+o0.2c/1.5c+f2",
