...
buffer03515 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/tanpa-gempa-diatas-7-mw-diurut-berdasarkan-waktu/batas-cluster/eps0.35min15-LN.shp")
...
fig.plot(data=buffer03515, pen="1p,black", label="ε=0.35 MinPts=15")

urut=[8, 0, 3, 4, 6, 7, 1, 2, 9, 5]
i=0
while i < len(urut):
    data = pd.read_csv("/mnt/d/celebes-stress-inversion-project/Result/tanpa-gempa-diatas-7-mw-diurut-berdasarkan-waktu/eps0.35min15/clustered/cls{}.csv".format(urut[i]))
    fig.text(
...
fig.savefig("/mnt/d/celebes-stress-inversion-project/generic-mapping-tools/maps/cluster3515.png")
#fig.show()