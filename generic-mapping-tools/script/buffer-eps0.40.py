...
fig.plot(data=buffer04015, pen="1p,black", label="ε=0.40 MinPts=15")

urut=[9, 0, 2, 5, 7, 8, 4, 1, 3, 6]
i=0
while i < len(urut):
    data = pd.read_csv("/mnt/d/celebes-stress-inversion-project/Result/tanpa-gempa-diatas-7-mw-diurut-berdasarkan-waktu/eps0.40min15/clustered/cls{}.csv".format(urut[i]))
    fig.text(
...
fig.savefig("/mnt/d/celebes-stress-inversion-project/generic-mapping-tools/maps/cluster04015.png")
#fig.show()