...
buffer04515 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/tanpa-gempa-diatas-7-mw-diurut-berdasarkan-waktu/batas-cluster/eps0.45min15-LN.shp")
...
fig.plot(data=buffer04515, pen="1p,black", label="ε=0.45 MinPts=15")

urut=[6, 0, 2, 5, 9, 10, 4, 1, 7, 3, 8]
i=0
while i < len(urut):
    data = pd.read_csv("/mnt/d/celebes-stress-inversion-project/Result/tanpa-gempa-diatas-7-mw-diurut-berdasarkan-waktu/eps0.45min15/clustered/cls{}.csv".format(urut[i]))
    fig.text(
...
fig.savefig("/mnt/d/celebes-stress-inversion-project/generic-mapping-tools/maps/cluster04515.png")
#fig.show()