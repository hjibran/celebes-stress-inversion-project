...
fig.plot(data=buffer05015, pen="1p,black", label="ε=0.50 MinPts=15")

urut=[6, 0, 2, 5, 4, 1, 7, 3, 9, 8]
i=0
while i < len(urut):
    data = pd.read_csv("/mnt/d/celebes-stress-inversion-project/Result/tanpa-gempa-diatas-7-mw-diurut-berdasarkan-waktu/eps0.50min15/clustered/cls{}.csv".format(urut[i]))
    fig.text(
...
fig.savefig("/mnt/d/celebes-stress-inversion-project/generic-mapping-tools/maps/cluster05015.png")
#fig.show()