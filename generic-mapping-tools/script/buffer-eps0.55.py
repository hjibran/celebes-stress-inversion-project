...
buffer05515 = gpd.read_file("/mnt/d/celebes-stress-inversion-project/Result/tanpa-gempa-diatas-7-mw-diurut-berdasarkan-waktu/batas-cluster/eps0.55min15-LN.shp")
...
fig.plot(data=buffer05515, pen="1p,black", label="ε=0.55 MinPts=15")

urut=[3, 0, 1, 4, 2, 7, 5, 6]
i=0
while i < len(urut):
    data = pd.read_csv("/mnt/d/celebes-stress-inversion-project/Result/tanpa-gempa-diatas-7-mw-diurut-berdasarkan-waktu/eps0.55min15/clustered/cls{}.csv".format(urut[i]))
    fig.text(
...
fig.savefig("/mnt/d/celebes-stress-inversion-project/generic-mapping-tools/maps/cluster05515.png")
#fig.show()