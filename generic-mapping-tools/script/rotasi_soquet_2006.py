...
grid = pygmt.datasets.load_earth_relief(resolution="30s", # resolution of earth relief
                                        region= [117.5, 132, -8.7, 4], #[117.5, 127.7, -8.5, 4], boarder of map: [minlon, maxlon, minlat, maxlat]
...
fig.basemap(rose="jTR+3c+lW,E,S,N+o0.3c/0.3c+f2")
